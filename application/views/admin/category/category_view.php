								...
								<div class="row justify-content-md-center">
									...
									<div class="col col-lg-12">
										<div class="row justify-content-md-center">
											...
											$top_title = ucwords(str_replace("-",' ',$row->Name));
											?>
											...
											<div class="row mt-3">
												...
												<div class="col-6" >
													...
													<div class="form-group">
														<input class="form-control input-custom" name="<?php echo $row->CategoryId ?>" id="<?php echo $row->CategoryId ?>" type="text" value="<?php echo $top_title ?>" readonly="" />
													</div>
						...
						<div class="col-12 mt-lg-3">
							...
							<div class="form-group text-left">                
								<label class="radio-inline">
									<input type="radio" name="optradio" value="1" id="optradio" > Mobile No
								</label>
								<label class="radio-inline">
									<input type="radio" name="optradio" value="2" id="optradio" >No Plate
								</label>
								<label class="radio-inline">
									<input type="radio" name="optradio" value="3" checked="" id="optradio" >other
								</label>
							</div></div>
