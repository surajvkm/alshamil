        ...
        $this->view('admin/admin_header'); 
            ...
            <div class="container">
                <div class="row">
                    ...
                    $this->view('admin/admin_sidebar'); 
                     ?>
                    <h6 id="db_yrlytitle">INDIVIDUAL PLAN</h6>
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-6 col-sm-6 pt-md-20 px-md-0">
                         <div class="row pl-25">
                             ...
                             <div class="col-sm-12 col-md-12 px-md-0">
                                 <span class="font-black"><?php echo $r->traderFullName?></span>
                             </div>
                         </div>
                     </div>
                 </div>
         ...
         <div class="col-sm-7 col-md-7 px-md-0">  <!---- id=coldiv2--- -->
             <div class="row">
                 <div class="col-sm-3 col-md-3 text-right pt-md-20">
                 <?php 
                 ...
                 <div class="col-md-9">
                         <div class="row">
                             <div class="col-sm-5 col-md-5 pt-md-20">
                             ...
                             <div class="col-sm-3 col-md-3 pt-md-20 px-md-0">
                             ...
                             <div class="col-sm-4 col-md-4 pt-md-20">
                     ...
                     <div class="sideline1"></div>   <!--adyrhrdiv2 -->
             </div>
         </div>
         <div class="col-sm-2 col-md-2 pt-md-20">  <!---id=coldiv3-->     
             <div class="row">
