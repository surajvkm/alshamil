                                        <div class="col-6" style='float:none;display:inline-block;'  >
                                                                                                <div class="form-group">
                                                                                                    <label class="text-s12 text-semibold" for="">Sub Category</label>

                                                <select class="form-control input-custom" name="txtsubcat" id="txtbrand" onchange="fetch_model(this.value)">
                                                    <option value="">--Select--</option>
                                                    <?php
                                                    foreach ($prop_qry as $brand) {
                                                        ?>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label class="text-s12 text-semibold" for="">Type</label>
                                                 
                                                    <select class="form-control input-custom" name="txtprop" id="srchccat3">
                                                        <option value="">--Select--</option>
                                                    </select>
                                                    <label id="err_txtprop" class="txt_errors">Please Select Your Property Type</label>
                                                    </div>
                                                </div>
                                                <!-- --- Year --- -->
                                                <div class="col-6">
                                                  <!--  <div class="form-group">
                                                        <label class="text-s12 text-semibold" for="">Location</label>
                                                        <input type="text" name="location"  id="txt_location" class="form-control input-custom" >
                                                    <label id="err_txtyear" class="txt_errors">Please Enter Location</label>
                                                    </div>-->
                                                    <input type="hidden" name="location"  id="txt_location" class="form-control input-custom" value=''>
                                                </div>
                                            </div>
