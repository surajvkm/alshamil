                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control input-custom" name="txtyear" id="txtyear">
                                                        <option value="">--Select--</option>
                                                        <?php
       ...
       $("#drop_zone1").change(function (e) {
        ...
        $(addButton).click(function (e) { 
            ...
            var fieldHTML = '<div class="card add-card"><div class="addIcon-P h-100"><div class="dropZoneContainer" id="more_drop_camera" style="width: 107px;position: relative;">'
                ...
                + '<input onchange="previewImg(id_x,event)" id="new_x" type="file"  name="txtfiles[]"  class="FileUpload1 " style="opacity: 0.0; position: absolute; top: 0; left: 0; bottom: 0; right: 0; width:100px;" />'
                +'</br>';
