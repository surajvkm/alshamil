                                                ...
                                                <div class="col-sm-3 col-12 px-1 px-md-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 text-center pt-3 pl-md-3 pl-0 pr-md-3 pr-0">
                                                            <img class="profileImage" src="<?php echo $result->image?>" alt="">
                                                        </div>

                                                        <div class="col-12 text-center px-lg-3 pt-2 pl-0 pr-0">
                                                            <!-- Name -->
                                                            <p class="mb-2 text-orange text-s15 text-semibold"><?php echo ucfirst($result-> fullName); ?></p>
                                                            <?php 
                                                        ...
                                                        <div class="col-12 pt-lg-3 pt-md-2 mb-lg-2 px-lg-3 pl-md-2 mb-3 pr-1 pr-md-2 ml-sm-0 ml-md-0">
                                                            <div class="row">
                                                                ...
                                                                <a href="<?php echo base_url().'admin/edit_trader/'.$result->traderId ;?>">
                                                                ...
                                                                <button class="btn btn-red text-resize pt-1 pb-1 pl-md-2 w-90 text-s14 freeze_btn"  value="<?php echo $result->traderId?>"> <?php echo ($result->isActive==-1? "Freezed": 'Freeze')?> </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            ...
                                                                            <p class="mb-0 text-s13 text-resize text-semibold text-readjust " style="color: #282828;"><?php echo $result->location; ?></p>
                                                                            <hr class="mt-2 mb-1">
                                                                        </div>
                                                                        ...
                                                                        <div class="col-12 pt-lg-2">
                                                                            ...
                                                                            <p class="mb-0 text-s13 text-email text-semibold text-adjust" style="color: #282828;"><?php echo $result->email; ?></p>
                                                                            <hr class="mt-2 mb-1">
                                                                        </div>
                                                                        ...
                                                                        <div class="col-12 pt-lg-2">
                                                                            ...
                                                                            <p class="mb-0 text-s13 text-resize text-semibold text-readjust " style="color: #282828;"><?php echo $result->contactNumber; ?></p>
                                                                            <hr class="mt-2 mb-1">
                                                                        </div>
                                                                ...
                                                                <div class="col-6 vbl border-height mt-lg-3 mb-2 pl-lg-4 pr-lg-4 px-1 px-md-3">
                                                                    <div class="row">
                                                                        ...
                                                                        <a download="attachment1.jpg" href="<?php if(isset($result->idProof))echo $result->idProof?>" title="ImageName">
                                                                            <img class="profile-attachments1" style="width:100%;" src="<?php if(isset($result->idProof))echo $result->idProof?>" alt=''>
                                                                        </a>
                                                                        </div>

                                                                        <!-- Second -->
                                                                        <div class="col-12 pl-lg-4 pr-lg-4 pt-lg-0 pt-2">
                                                                        <a download="attachment2.jpg" href="<?php if(isset($result->idProof2))echo $result->idProof2 ?>" title="ImageName">
                                                                        <img class="profile-attachments" style="width:100%;" src="<?php if(isset($result->idProof2))echo $result->idProof2?>" alt=''>
                                                                        </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 mt-3 pr-md-2 pr-lg-3">
                                                            <div class="card-yellowForm">
                                                                ...
                                                                AED <?php if($soldamount>0 && !empty($soldamount) && isset($soldamount))echo $soldamount;else echo 0; ?>
                                                        ...
                                                        <div class="col-12 mt-2 pr-md-2 pr-lg-3">
                                                            <div class="card-yellowForm">
                                                                ...
                                                                <p class="mb-0 text-s16 text-semibold text-adjust" style="color: #282828;"><?php echo $result->postCount; ?></p>
                                                            </div>
                                                        </div>
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div class="col-12 mt-lg-3">
                                                                                            <div class="form-group text-left">
                                                                                                ...
                                                                                                <input class="form-control input-custom"   name="date_validity" id="date_validity" value="<?php  echo set_value('date_validity',$result->planValidity) ?>"  >
                                                                                        ...
                                                                                        <div class="col-12 mt-lg-3">
                                                                                            <div class="form-group text-left">
                                                                                                <label class="text-s12 text-semibold ml-lg-2 mb-1" style="color: #7F7F7F;" for="">Posts Extended</label>
                                                                                                  ...
                                                                                                  <input type="number" min="0" data-type="post_validity" name="post_validity" id="post_validity" value="<? echo ($result->postCount<0)?set_value('post_validity','Unlimited'):set_value('post_validity',$result->postCount) ?>" class="form-control input-custom">
...
$('.datepicker').datepicker();
   ...
   // alert(number_value);
    ...
    $(document).ready(function() {
        var plan ="<?php echo $pid;?>";
        var trader ="<?php echo $tid;?>";
       ...
       // console.log(plan+','+status+','+trader+','+id);
          $('#'+id).DataTable( {
            ...
            "ajax": {
                ...
                "url": "<?php echo base_url(); ?>admin/getPostByStatus/"+plan+'/'+status+'/'+trader,
                "type": "POST",
                "dataType": "json",
