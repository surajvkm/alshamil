        ...
        <div class="col-12 p-0">
            <div class="row">
                ...
                <div class="col-sm-3 col-4 mt-3 mb-lg-3 vbr pt-lg-0 px-lg-3 px-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-8 pl-md-4 pl-sm-4 pr-0">
                            <span class="text-s13 text-semibold textadjust pl-md-1 pl-sm-2" style="color: #404040;">
                ...
                <div class="col-1 pt-3 pr-lg-2 text-lg-right pl-1 pl-lg-3">
                    ...
                    {
                        ?>
                        <img src="<?php echo $r->image ?>" class="userImageW" >
                        <?php
                    }
                    else {
                        ?>
                ...
                <div class="col-3 mt-4 mb-lg-3 vbr pl-4 pl-sm-3 pr-0 pr-md-3 pr-sm-3 pl-md-3">
                    <p class="mb-0 text-s13 text-orange text-semibold textadjust pl-2 pl-md-0 pl-sm-0"><?php echo ucfirst($r->fullName)?></p>
                    <p class="mb-0 text-s12 text-semibold textadjust" style="color: #747474;"><?php echo ucfirst($r->location)?></p>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 col-12 bg-watchListUsers h-67 mb-2" <?php echo $class; ?>>
                <div class="row overflow-hidden pr-lg-3">
                    ...
                    <div class="col-3 pr-lg-2 pt-2 pb-lg-2 pl-lg-3 pl-md-2">
                        ...
                        if($r->image != '') {
                        ?>
                            <img src="<?php echo $r->image?>" class="userImageW" alt="">
                        <?php
                        }
                        else {
                        ?>
                    ...
                    <div class="col-9 pt-3 pl-lg-0 pl-md-2 pb-lg-3 pr-lg-3 pr-md-0 px-sm-1 px-0">
                        ...
                        <p class="mb-0 text-s12 textresize text-orange text-semibold"><?php echo ucfirst($r->fullName)?></p>
                        <p class="mb-0 text-s11 textresize text-semibold" style="color: #747474;"><?php echo ucfirst($r->location)?></p>
                    </div>
                </div>
            </div>
                <?php }?>
