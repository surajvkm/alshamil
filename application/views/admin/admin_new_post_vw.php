                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                			   ...
                			   ?>
                                        ...
                                        <div class="col-12 p-0">
                                            <div class="row h-77">
                                                ...
                                                <div class="col-2 px-lg-3 pr-0">
                                                    <img class="productImage" src="<?php echo $row->mainImage;?>" alt="">
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-4 col-3 mt-lg-3 mb-lg-3 vbr px-lg-3 px-1 px-md-2 pt-md-2 pt-sm-2 pt-lg-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-9 col-8 px-md-3 px-sm-3 pl-4 pr-0">
                                                            <span class="newPost-data textresize">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-9 col-8 pr-md-3 pr-sm-3 pr-0 pl-3 pl-md-3 pl-sm-3">
                                                            <span class="newPost-data textresize"><?php echo ($row->callForPrice==1)? 'Call for price':'AED '.$row->price; ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <img src="<?php echo $row->image;?>" class="userImage" >
                                    <?php 
                                }
                                else {
                                ...
                                ?>
                                                ...
                                                <div class="col-3 pt-lg-2 pl-lg-1 mr-lg-5 pl-sm-4 ml-3 ml-md-0 pl-3 pr-0 pr-md-3 pt-2">
                                                    <p class="mb-0 text-s13 textresize text-orange text-semibold"><?php echo ucfirst($row->fullName); ?></p>
                                                    <p class="mb-0 text-s12 textresize text-semibold" style="color: #5C5C5C;"><?php echo ucfirst($row->location); ?></p>
                                                    <p class="mb-0 text-s12 textresize text-semibold" style="color: #767676;">Posted on <?php echo ucfirst($row->submittedOn); ?></p>
                 
                                                </div>

                                                <!-- View Button -->
                                                <div class="col-lg-2 col-md-1 col-1 pt-3 px-md-0 px-lg-3 pl-0">
                                                    <a href="<?php echo base_url().'admin/post_details/'.$row->productId?>">
