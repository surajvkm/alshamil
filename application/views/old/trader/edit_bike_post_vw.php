...
<form  id="myForm" action="<?php echo base_url() ?>Trader/update_bikepost" enctype="multipart/form-data" method="post">
    <div id="first">
...
?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="txtprice"  id="txt_cprice" class="form-control" value="<?php echo $qry[0]->productBPrice ?>" <?php echo $readonly; ?>>
                                                ...
                                                <div class="col-md-2 editthumb category-dateview"> 
                                                    <div class="form-group">
                                                        <div class="dropZoneContainer">
                                                            ...
                                                            <img id="edit_main_imgprev"  class="edit_imgs" width="85x" src="<?php echo $qry[0]->Bpost_main_img ?>">
                                                            <input type="hidden" id="hid_main_img" name="edit_main_img" value="<?php echo $qry[0]->Bpost_main_img ?>">
                                                        </div>
                                                    </div>
                                                </div>
