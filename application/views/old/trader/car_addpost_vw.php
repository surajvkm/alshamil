...
<div class="col-md-6">
    <div class="form-group">
        ...
        <select class="form-control" name="txtmodel" id="srchccat3">
            <option value="">--Select--</option>
        </select>
        <label id="err_txtmodel" class="txt_errors">--Select--</label>
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
                    ...
                    success: function (data) {
                        ...
                        if(data!=0){
                            add_post_response(data); 
                                ...
                                if ((txtcat == '') || (txtbrand == '') || (txtmodel == '') || (txtyear == '') || (txtdetails == '') || (txtaudio == '')||(set_price==0))
                                {
