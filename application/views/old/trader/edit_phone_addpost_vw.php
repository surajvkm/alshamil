...
<form  id="myForm" action="<?php echo base_url()?>Trader/update_phonepost" enctype="multipart/form-data" method="post">
                            ...
                            <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtbrand" id="txtbrand" onchange="fetch_model(this.value)" <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?>>
                                                <?php
                                                foreach ($phone_brand as $r) {
                                                    ?>
                                                    <option value="<?php echo $r->brandName ?>" <?php if ($r->brandName == $qry[0]->productPBrand) echo 'selected' ?>><?php echo $r->brandName ?></option>
                                                    <?php
                                                }
                                                ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="txtmodel" id="txtmodel" <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?> >
                                             <?php
                                        foreach($phone_model as $r)
                                        {
                                            ?>
                                            <option value="<?php echo $r->modelName?>" <?php if($r->modelName == $qry[0]->productPModel) echo 'selected'?>><?php echo $r->modelName ?></option>
                                       <?php
                                            }
                                        ?>
                                        </select>
                          ...
                          <div class="col-md-12"></div>
                                  ...
                                  <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="txtprice"  id="txt_cprice" class="form-control" value="<?php echo $qry[0]->productPHPrice ?>" <?php echo $readonly; ?>>
                                ...
                                <div class="col-md-12">
                                  ...
                                  <textarea <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?> id="txtdetails" name="txtdetails"  class="form-control"><?php echo $qry[0]->productPDesc?></textarea>
                                                ...
                                                <div class="col-md-2 editthumb category-dateview"> 
                                                    <div class="form-group">
                                                        <div class="dropZoneContainer">
                                                            ...
                                                            <img id="edit_main_imgprev"  class="edit_imgs" width="85x" src="<?php echo $qry[0]->PHpost_main_img ?>">
                                                            <input type="hidden" id="hid_main_img" name="edit_main_img" value="<?php echo $qry[0]->PHpost_main_img ?>">
                                                        </div>
                                                    </div>
                                                </div>
