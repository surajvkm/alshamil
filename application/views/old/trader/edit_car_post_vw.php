...
<form  id="myForm" action="<?php echo base_url() ?>Trader/update_carpost" enctype="multipart/form-data" method="post">
    <div id="first">
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="txtcat" id="txtcategorya"  readonly>
                                ...
                                <div id="ggg">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtbrand" id="txtbrand" onchange="fetch_model(this.value)" <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?>>
                                                <?php
                                                foreach ($car_brand as $r) {
                                                    ?>
                                                    <option value="<?php echo $r->brandName ?>" <?php if ($r->brandName == $qry[0]->productCBrand) echo 'selected' ?>><?php echo $r->brandName ?></option>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtmodel" id="txtmodel"  <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?>  >
                                                <?php
                                                foreach ($car_model as $r) {
                                                    ?>
                                                    <option value="<?php echo $r->modelName ?>" <?php if ($r->modelName == $qry[0]->productCModel) echo 'selected' ?>><?php echo $r->modelName ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtyear" id="txtyear" <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?>>
                                                <option value="">--Select--</option>
<?php
for ($i = 1970; $i <= date('Y'); $i++) {
    ?>
                                                    <option value="<?php echo $i ?>" <?php if ($i == $qry[0]->productCReleaseYear) echo 'selected' ?>><?php echo $i ?></option>
                                                    <?php
                                                }
                                                ?>
...
?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="txtprice"  id="txt_cprice" class="form-control" value="<?php echo $qry[0]->productCPrice ?>" <?php echo $readonly; ?>>
                                            <label id="err_txt_cprice" class="txt_errors">Enter Price</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="usr" class="addpost_lbl">Details</label>
                                        <textarea id="txtdetails" name="txtdetails"  class="form-control " <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?>><?php echo $qry[0]->productCDesc ?></textarea>
                                                ...
                                                <div class="col-md-2 editthumb category-dateview"> 
                                                    <div class="form-group">
                                                        <div class="dropZoneContainer">
                                                            ...
                                                            <img id="edit_main_imgprev"  class="edit_imgs" width="85x" src="<?php echo $qry[0]->Cpost_main_img ?>">
                                                            <input type="hidden" id="hid_main_img" name="edit_main_img" value="<?php echo $qry[0]->Cpost_main_img ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            for ($j = 0; $j < 3; $j++) {
                                                ...
                                                if ($img != '') {
                                                    ...
                                                    <div class="col-md-2 editthumb category-dateview">
                                                        <div class="form-group">
                                                                <div class="dropZoneContainer">
                                                                    <input type="file" id="car_img_<?php echo $j ?>" name="txtfiles[]" class="addFileUpload" accept=".jpg,.png,.gif"  />
        ...
        <div class="row">
            <div class="col-sm-12" >
                ...
                <div class="col-md-6" >
                    ...
                    <div class="col-md-6" >
                        <div class="form-group">
                            <button type="submit" class="btn btn-default btnplantypes" id="btnsavepost" > POST</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-3" ></div>
