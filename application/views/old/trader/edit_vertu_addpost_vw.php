...
<form  id="myForm" action="<?php echo base_url() ?>Trader/update_vertupost" enctype="multipart/form-data" method="post">
    <div id="first">
                                ...
                                <div id="ggg">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtbrand" id="txtbrand" onchange="fetch_model(this.value)" <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?> >
                                                <?php
                                                foreach ($vertu_brand as $r) {
                                                    ?>
                                                    <option value="<?php echo $r->brandName ?>" <?php if ($r->brandName == $qry[0]->productVBrand) echo 'selected' ?>><?php echo $r->brandName ?></option>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtmodel" id="txtmodel" <?php echo ($_SESSION['logged_in']['plantype']==1)? 'readonly':''; ?> >
                                                <?php
                                                foreach ($vertu_model as $r) {
                                                    ?>
                                                    <option value="<?php echo $r->modelName ?>" <?php if ($r->modelName == $qry[0]->productVModel) echo 'selected' ?>><?php echo $r->modelName ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="txtprice"  id="txt_cprice" class="form-control" value="<?php echo $qry[0]->productVPrice ?>" <?php echo $readonly; ?>>
                                            <label id="err_txt_cprice" class="txt_errors">Enter Price</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="usr" class="addpost_lbl">Details</label>
                                        <textarea id="txtdetails" name="txtdetails"  class="form-control "><?php echo $qry[0]->productVDesc ?></textarea>
                                                ...
                                                <div class="col-md-2 editthumb category-dateview"> 
                                                    <div class="form-group">
                                                        <div class="dropZoneContainer">
                                                            ...
                                                            <img id="edit_main_imgprev"  class="edit_imgs" width="85x" src="<?php echo $qry[0]->Vpost_main_img ?>">
                                                            <input type="hidden" id="hid_main_img" name="edit_main_img" value="<?php echo $qry[0]->Vpost_main_img ?>">
                                                        </div>
                                                    </div>
                                                </div>
