                ...
                <div class="col-sm-9" id="imgpost_div">
                    ...
                    <div class="row">
                        <div class="col-sm-3" class="catpostimgs">
                            <a href=""> <img src="<?php echo $q->image ?>" class="post_imgs"></a>
                            <div class="tradet_details">
                                <span class="wlprdpr">Product</span>&nbsp;&nbsp;<b><span class="prdt_price_details"><?php echo  $q->category ?></span></b><br>
                                <span class="wlprdpr">Price</span>&nbsp;&nbsp;<b><span class="price_span">$230</span></b>
                                <hr class="cat_hr">
                                <img src="<?php echo base_url() ?>img/userProfileIcon_gray.png" class="cat_user_prof"/>
                                <p class="cat_uname"><?php echo $this->Trader_mdl->getTraderName($q->tId) ;?></p>
                                <p class="cat_uplace">Location</p>
                                <p class="cat_udate">11-11-2018</p>
                            </div>
                        </div> 
                    <?php } ?>
                     </div>    
