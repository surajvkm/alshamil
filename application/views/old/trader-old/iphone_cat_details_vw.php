                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div id="category_det_title_div">
                                <h5 id="category_det_title"><?php echo $qry[0]->productPBrand." ".$qry[0]->productPModel?></h5>
                                <!--hr id="mobcategory_det_hr"-->
                                <?php $currency = "AED";?>
                                <span id="cat_det_amt"><?php echo $currency." ".$qry[0]->productPHPrice?></span>
                            </div>
...
<!--                                <div>
                            ...
                            ?>
                                    <div class="item">
                                            <img src="<?php echo $r->PHpost_main_img ?>"  id="cat_trader_videos" >
                                            <div class="ow_prdt_slider">
                                                <span class="spownview">Views</span>
                                                <span class="spowncnt"><?php echo $r->productViewCount?></span>
                                            </div>
                    ...
                    foreach($iphone_img_qry as $r)
                            {
                        ?>
                                   <img src="<?php echo $r->PHpost_main_img?>" class="fiveimgs" id="five_post_imgs1">
                          <?php break;
                          }
                            ?>
                                    <?php
...
<!--                                <span id="poster_contact"><?php echo $qry[0]->traderContactNum?></span>-->
                            ...
                            <div class="row" id="cart_btns">
                             ...
                             <button id="flag_btn" class="btn" onclick="show_flag_modal('<?php echo $qry[0]->productCategoryID?>','<?php echo $qry[0]->productID?>','<?php echo $qry[0]->cartPHType?>','<?php echo $qry[0]->postID?>','<?php echo $qry[0]->traderID?>')">   <img src="<?php echo base_url();?>img/post-flag.png"  id="img_flag" >Flag Post</button><br>

                                <?php
                                if($qry[0]->cartPHType == 1)
                                {
                                    ?>
...
<!--                                <button id="addcart_btn" onclick="cartlist_pg('<?php echo $qry[0]->productID?>')"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Add to Cart</button>-->
                    ...
                    <div class="col-sm-9" >
                        ...
                        <div id="history_descr_div">
                            <p id="hist_descr"><?php echo $qry[0]->productPDesc?></p>
                        </div>
                    </div>
            ...
            <div class="row">
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="Login">
                     <form role="form" class="form-horizontal" action="<?php echo base_url();?>Trader/sendmail_phone/<?php echo $qry[0]->productID;?>" method="post">
                        </br> 
                        <div class="form-group">
