...
<!--               <p id="post_bal">You have 140 post balance</p>-->
        ...
        <div class="col-sm-9">
         ...
         <div class="col-sm-9 trimgpost_div" id="sold_div">
            <div class="row">
                <?php
                ...
                <div class="col-sm-3 clsoldimgs">
                   ...
                   <div class="other_prddet">
                     <div class="other_div1">
                        ...
                        <span class="other_prd">Price</span><span class="other_val" id="sp_price"><?php echo $currency." ".$product_price?></span>
                     </div>
                     ...
                     <div class="other_div2">
                        ...
                        <span class="other_date"><?php echo date('d M Y',$d1)?></span>
                         <button class="btn_soldrm" id="btneditpost">Remove</button>
                     </div>
                  </div>
               </div>
