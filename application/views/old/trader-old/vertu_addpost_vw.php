                            ...
                            <div id="resl_div">
                                ...
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="call_for_price" id="chkbox_callpr1" class="form-control reginputs"><span id="call_for_price4" >Call for Price</span>
            ...
            $(document).ready(function(){
               ...
               $('#btnvertuadpost').click(function () {
                        ...
                        } else
                        {
                            ...
                            $.ajax({
                                url: "<?php echo base_url('Trader/save_vertupost'); ?>",
                                ...
                                success: function (data) {
                                    if(data == 'success')
                                    {
                                        swal("Vertu Post Details added successfully");
                                    }
                                    //console.log(data);
        ...
        $("#car_img").change(function () {
            ...
            readaudioURL(this);
                ...
                var fieldHTML = '<div class="dropZoneContainer" id="more_drop_camera" style="width: 107px;position: relative;left: 15px;">'
                  +'<input type="file" id="car_img" name="txtimage" class="FileUpload" required=""/>'
		  ...
		  +'</div>'
                ...
                + '<input type="file" id="drop_zone21" name="txtfiles[]" class="FileUpload" style="opacity: 0.0; position: absolute; top: 0; left: 0; bottom: 0; right: 0; " />';
                  +'<br>';
               ...
               if((x=='Mobile Number')||(x=='Iphone'))
                ...
                if((x=='Vertu')||(x=='Watch') ||(x=='Boat'))
                {
                   ...
                   $('#mob_div').css('display','none');
                    ...
                    location.href="verwatch_add_post";
                     $('.catsel').setItem('selected', $(this).val());
                ...
                if(x=='Number Plate')
                {
                   ...
                   $('#mob_div').css('display','none');
                    ...
                    location.href="numberplate_add_post"; 
                     $('.catsel').setItem('selected', $(this).val());
                }
                if(x=='Properties')
                {
                   $('#resl_div').css('display','none');
                    ...
                    location.href="property_add_post"; 
                     $('.catsel').setItem('selected', $(this).val());
                }
            }
