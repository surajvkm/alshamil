                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            ...
                            <div id="category_det_title_div">
                                <span id="category_det_title"><?php echo $qry[0]->productNPCode." ".$qry[0]->productNPDigits?></span><!--hr id="mobcategory_det_hr"-->
                                <?php $currency = "AED";?>
                                <span id="cat_det_amt"><b id="cat_det_amt"><?php echo $currency." ".$qry[0]->productNPPrice?></span></b>
                            </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                <div>
                                    <img id="noplateimg" src="<?php echo $qry[0]->NPpost_main_img?>">
                        ...
                        <div class="col-sm-4">
                            <div class="row" id="cat_owner">
                               ...
                               <?php
                                    ...
                                    {
                                        ?>
                                         <img src="<?php echo $qry[0]->traderImage?>" id="owner_prof">
                                     <?php
                                    }
                                    else
                                    {
...
<!--                               <button class="btn btn-default btncons" id="catdet_phone"> <span id="poster_contact"><?php echo $qry[0]->traderContactNum?></span></button>-->
<!--                                <span id="poster_contact"><?php echo $qry[0]->traderContactNum?></span>-->
                           ...
                           <div class="row" id="cart_btns">
                                ...
                                <button id="shared_btn" class="btn" onclick="shared_modal('<?php echo $qry[0]->productCategoryID?>','<?php echo $qry[0]->productID?>')"  data-target="#dataModal" data-toggle="modal" data-id="<?php echo $qry[0]->productID;?>">  <img src="<?php echo base_url();?>img/post-share.png"  id="img_shared" ><span class="btns_txts">Share</span></button><br>
                             ...
                             <button id="flag_btn" class="btn" onclick="show_flag_modal('<?php echo $qry[0]->productCategoryID?>','<?php echo $qry[0]->productID?>','<?php echo $qry[0]->cartNPType?>','<?php echo $qry[0]->postID?>','<?php echo $qry[0]->traderID?>')">   <img src="<?php echo base_url();?>img/post-flag.png"  id="img_flag" >Flag Post</button><br>

                                <?php
                                if($qry[0]->cartNPType == 1)
                                {
                                    ?>
...
<!--                                <button id="addcart_btn" onclick="cartlist_pg('<?php echo $qry[0]->productID?>')"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Add to Cart</button>-->
                    ...
                    <div class="col-sm-9" >
                        ...
                        <div id="history_descr_div">
                            <p id="hist_descr"><?php echo $qry[0]->productNPDesc?></p>
                        </div>
                    </div>
            ...
            <div class="row">
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="Login">
                     <form role="form" class="form-horizontal" action="<?php echo base_url();?>Trader/sendmail_noplate/<?php echo $qry[0]->productID;?>" method="post">
                        </br> 
                        <div class="form-group">
