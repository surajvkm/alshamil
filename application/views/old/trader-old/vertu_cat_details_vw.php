                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div id="category_det_title_div">
                                ...
                                <h5 id="category_det_title"> <?php echo $qry[0]->productVBrand." ".$qry[0]->productVModel;?></h5>
                                <!--hr id="mobcategory_det_hr"-->
                                <?php $currency = "AED";?>
                                <span id="cat_det_amt"><?php echo $currency." ".$qry[0]->productVPrice?></span>
                            </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-5">
                            ...
                            ?>
                                    <div class="item">
                                            <img src="<?php echo $r->Vpost_main_img ?>"  id="cat_trader_videos" >
                                            <div class="ow_prdt_slider">
                                                <span class="spownview">Views</span>
                                                <span class="spowncnt"><?php echo $r->productViewCount?></span>
                                            </div>
                    ...
                    foreach($vertu_img_qry as $r)
                            {
                        ?>
                                   <img src="<?php echo $r->Vpost_main_img?>" class="fiveimgs" id="five_post_imgs1">
                          <?php break;
                          }
                            ?>
                                    <?php
                    foreach($vertu_img_qry as $r)
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row" id="cart_btns">
                             ...
                             <button id="flag_btn" class="btn" onclick="show_flag_modal('<?php echo $qry[0]->productCategoryID?>','<?php echo $qry[0]->productID?>','<?php echo $qry[0]->cartVType?>','<?php echo $qry[0]->postID?>','<?php echo $qry[0]->traderID?>')">   <img src="<?php echo base_url();?>img/post-flag.png"  id="img_flag" >Flag Post</button><br>

                                <?php
                                if($qry[0]->cartVType == 1)
                                {
                                    ?>
...
<!--                                <button id="addcart_btn" onclick="cartlist_pg('<?php echo $qry[0]->productID?>')"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Add to Cart</button>-->
                    ...
                    <div class="col-sm-9" >
                        ...
                        <div id="history_descr_div">
                            <p id="hist_descr"><?php echo $qry[0]->productVDesc?></p>
                        </div>
                    </div>
