                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div id="category_title_div">
                                <h5 id="category_title">BOATS</h5><!--hr id="category_hr"--><b><span id="category_cnt">(<b><?php echo $count?></b> Product Listed)</span></b>
                            </div>
                        ...
                        <div class="row">
                           ...
                           ?>
                            <div class="col-sm-3 catpostimgs">
                                ...
                                <a href="<?php echo base_url()?>Trader/boat_category_details/<?php echo $result->productID;?>/<?php echo $result->productCategoryID;?>"> <img src="<?php echo  $result->productImage; ?>" class="post_imgs"></a>
                                    <div class="tradet_details">
                                       <span class="wlprdpr">Product</span>&nbsp;&nbsp;<b><span class="prdt_price_details"><?php echo $result->productCategoryName;?></span></b><br>
                                        <?php $currency = "AED";?>
                                       <span class="wlprdpr">Price</span>&nbsp;&nbsp;<b><span class="price_span"><?php echo $currency." ".$result->productBTPrice;?></span></b>
                                        <hr class="cat_hr">
                                        <?php
