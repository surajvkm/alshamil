...
<div class="row">
    ...
    <div class="col-sm-6" >
        <div class="form-group">
            ...
            <input type="text" name="txtprice"  id="txt_cprice" class="form-control reginputs" >
        ...
        $('#btncaradpost').click(function () {
            ...
            } else
            {
                 ...
                 /*$(".FileUpload1").each(function() {
                    ...
                    //console.log(test_array);return false;
//                    for(var i = 0; i < test_array.length; i++)
//                    {
//                    formData.append("fileToUpload[]", test_array[i]);
//                    }
//                 
            
                 /*var ins = document.getElementById('drop_zone21').files.length;
                    for (var x = 0; x < ins; x++) {
                        formData.append("files[]", document.getElementById('drop_zone21').files[x]);
                    }*/                
