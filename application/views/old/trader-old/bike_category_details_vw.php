               ...
               <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            ...
                            <div id="category_det_title_div">
                                ...
                                <h5 id="category_det_title"><?php echo $query[0]->productBBrand." ".$query[0]->productBModel ?></h5>
                                <!--hr id="category_det_hr"-->
                                <?php $currency = "AED";?>
                                <span id="cat_det_amt"><?php echo $currency." ".$query[0]->productBPrice; ?></span>
                            </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-5">
                            ...
                            ?>
                                    <div class="item">
                                            <img src="<?php echo $r->Bpost_main_img ?>"  id="cat_trader_videos" >
                                            <div class="ow_prdt_slider">
                                                <span class="spownview">Views</span>
                                                <span class="spowncnt"><?php echo $r->productViewCount?></span>
                                            </div>
                    ...
                    foreach($bike_img_qry as $r)
                            {
                        ?>
                                   <img src="<?php echo $r->Bpost_main_img?>" class="fiveimgs" id="five_post_imgs1">
                          <?php break;
                          }
                            ?>
                                    <?php
...
<!--                                        <button class="btn btn-default btncons" data-toggle="modal" data-target="#myModal" id="catdet_mailbtn">Mail</button>-->
                             ...
                             <button id="flag_btn" class="btn" onclick="show_flag_modal('<?php echo $query[0]->productCategoryID?>','<?php echo $query[0]->productID?>','<?php echo $query[0]->cartBType?>','<?php echo $query[0]->postID?>','<?php echo $query[0]->traderID?>')">   <img src="<?php echo base_url();?>img/post-flag.png"  id="img_flag" >Flag Post</button><br>

                                <?php
                                if($query[0]->cartBType == 1)
                                {
                                    ?>
...
<div class="owl-one owl-carousel owl-theme">
                     <?php
                        ...
                        <div class="item<?php echo $item_class; ?>">
                                       ...
                                       <img src="<?php echo base_url().'uploads/product_images/'.$r->productImage?>"  class="recent_slimgs" >
            ...
            <div class="row">
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="Login">
                     <form role="form" class="form-horizontal" action="<?php echo base_url();?>Trader/sendmail_bike/<?php echo $query[0]->productID;?>" method="post">
                        </br> 
                        <div class="form-group">
