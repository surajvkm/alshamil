...
<!--                             <input type="hidden" name="product_id"  value="<?php echo $product_id; ?>"/>-->
                             <span id="category_det_title">+917-0000000000</span>
<!--                             <span><hr id="category_det_hr"></span>-->
                             <span id="cat_det_amt">AED 4500</span>        
                        </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                <div>
                                    <img id="noplateimg" src="<?php echo base_url();?>img/no_preview.png">
                    ...
                    <div class="col-sm-9" >
                        ...
                        <div id="history_descr_div">
                            <p id="hist_descr">dsfsdgdgfdhdfhgfhj</p>
                        </div>
                    </div>
