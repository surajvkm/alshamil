                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div id="category_title_div">
                                         ...
                                         <h5 id="category_title">WATCH</h5><!--hr id="category_hr"--><b><span id="category_cnt">(<b><?php echo $count?></b> Product Listed)</span></b>
                            ...
                            <div class="col-sm-3 catpostimgs">
                                    ...
                                    <div class="tradet_details">
                                       <span class="wlprdpr">Product</span>&nbsp;&nbsp;<b><span class="prdt_price_details"><?php echo $r->productCategoryName?></span></b><br>
                                        <?php $currency = "AED";?>
                                       <span class="wlprdpr">Price</span>&nbsp;&nbsp;<b><span class="price_span"><?php echo $currency." ".$r->productWPrice?></span></b>
                                        <hr class="cat_hr">
                                        <?php
                                    if($r->traderImage != '')
                                    {
...
<div class="owl-one owl-carousel owl-theme">
        ...
        <script>
            ...
            {
                location.href='<?php echo base_url()?>Trader/show_watch_details/'+product_id+'/'+cat_id;
            }
