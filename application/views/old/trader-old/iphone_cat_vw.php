                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div id="category_title_div">
                                         ...
                                         <h5 id="category_title">PHONE</h5><!--hr id="category_hr"--><b><span id="category_cnt">(<b><?php echo $count?></b> Product Listed)</span></b>
                    ...
                    <div class="col-sm-9" id="imgpost_div">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 catpostimgs">
                                    <img src="<?php echo $r->PHpost_main_img?>" class="post_imgs" onclick="show_details('<?php echo $r->productID?>','<?php echo $r->productCategoryID?>')"> 
                                    <div class="tradet_details">
                                       <span class="wlprdpr">Product</span>&nbsp;&nbsp;<b><span class="prdt_price_details"><?php echo $r->productPBrand." ".$r->productPModel?></span></b><br>
                                        <?php $currency = "AED";?>
                                       <span class="wlprdpr">Price</span>&nbsp;&nbsp;<b><span class="price_span"><?php echo $currency." ".$r->productPHPrice?></span></b>
                                        <hr class="cat_hr">
                                        <?php
                                    if($r->traderImage != '')
                                    {
...
<!--                    <div id="myCarousel"  class="carousel slide" data-ride="carousel">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next"><i class="glyphicon glyphicon-chevron-right" id="most_right_caro"></i></a>
        ...
        <script>
            ...
            {
                location.href='<?php echo base_url()?>Trader/show_iphone_details/'+product_id+'/'+cat_id;
            }
