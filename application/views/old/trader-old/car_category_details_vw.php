                ...
                <div class="col-sm-9">       
                    <div class="row">
                        <div id="category_det_title_div">
                             ...
                             <span id="category_det_title"><?php echo $query[0]->productCBrand." ".$query[0]->productCModel; ?></span>
<!--                             <span><hr id="category_det_hr"></span>-->
                             <?php $currency = "AED";?>
                             <span id="cat_det_amt"><?php echo $currency." ".$query[0]->productCPrice; ?></span>        
                        </div>
                    </div><!-- end row -->
                </div>
                <div class="col-sm-9">        
                        <div class="col-sm-5">
                            ...
                            ?>
                                    <div class="item">
                                            <img src="<?php echo $r->Cpost_main_img ?>"  id="cat_trader_videos" >
                                            <div class="ow_prdt_slider">
                                                <span class="spownview">Views</span>
                                                <span class="spowncnt"><?php echo $r->productViewCount?></span>
                                            </div>
                ...
                <div id="imgfivediv">
                    ...
                    foreach($car_img_qry as $r)
                            {
                        ?>
                                   <img src="<?php echo $r->Cpost_main_img?>" class="fiveimgs" id="five_post_imgs1">
                          <?php break;
                          }
                            ?>
                                    <?php
                    foreach($car_img_qry as $r)
                        ...
                        <div class="col-sm-3 prof_carwdiv">
...
<!--                                        <button class="btn btn-default btncons" data-toggle="modal" data-target="#myModal" id="catdet_mailbtn">Mail</button>-->
                            ...
                            <div class="row" id="cart_btns">
                             ...
                             <button id="flag_btn" class="btn" onclick="show_flag_modal('<?php echo $query[0]->productCategoryID?>','<?php echo $query[0]->productID?>','<?php echo $query[0]->cartCType?>','<?php echo $query[0]->postID?>','<?php echo $query[0]->traderID?>')">   <img src="<?php echo base_url();?>img/post-flag.png"  id="img_flag" >Flag Post</button><br>

                                <?php
                                if($query[0]->cartCType == 1)
                                {
                                    ?>
...
<!--                                <button id="addcart_btn" onclick="cartlist_pg('<?php echo $query[0]->productID?>')"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Add to Cart</button>-->
                ...
                <div class="col-sm-12 cat_veh_his">
                    <div class="col-sm-3">
                    </div>
                    <div class="col-sm-9" >
                        <p id="history_title" >VEHICLE HISTORY</p>
                        <div id="history_descr_div">
                            <p id="hist_descr"><?php echo $query[0]->productCDesc?></p>
                        </div>
                    </div>
