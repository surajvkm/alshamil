               ...
               <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div id="category_det_title_div">
                                ...
                                <h5 id="category_det_title"><?php echo $query[0]->productPropSC." ".$query[0]->productPropType; ?></h5>
                                <!--hr id="category_det_hr"-->
                                <?php $currency = "AED";?>
                                <span id="cat_det_amt"><?php echo $currency." ".$query[0]->productPRPrice; ?></span>
                            </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-5">
                            ...
                            ?>
                                    <div class="item">
                                            <img src="<?php echo $r->PRpost_main_img ?>"  id="cat_trader_videos" >
                                            <div class="ow_prdt_slider">
                                                <span class="spownview">Views</span>
                                                <span class="spowncnt"><?php echo $r->productViewCount?></span>
                                            </div>
                    ...
                    foreach($prop_img_qry as $r)
                            {
                        ?>
                                   <img src="<?php echo $r->PRpost_main_img?>" class="fiveimgs" id="five_post_imgs1">
                          <?php break;
                          }
                            ?>
                                    <?php
...
<!--                                        <button class="btn btn-default btncons" data-toggle="modal" data-target="#myModal" id="catdet_mailbtn">Mail</button>-->
                            ...
                            <div class="row" id="cart_btns">
                             ...
                             <button id="flag_btn" class="btn" onclick="show_flag_modal('<?php echo $query[0]->productCategoryID?>','<?php echo $query[0]->productID?>','<?php echo $query[0]->cartPRType?>','<?php echo $query[0]->postID?>','<?php echo $query[0]->traderID?>')">   <img src="<?php echo base_url();?>img/post-flag.png"  id="img_flag" >Flag Post</button><br>

                                <?php
                                if($query[0]->cartPRType == 1)
                                {
                                    ?>
...
<!--                                <button id="addcart_btn" onclick="cartlist_pg('<?php echo $query[0]->productID?>')"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Add to Cart</button>-->
                    ...
                    <div class="col-sm-9" >
                        <p id="history_title" >PROPERTY HISTORY</p>
                        <div id="history_descr_div">
                            <p id="hist_descr"><?php echo $query[0]->productDesc?></p>
                        </div>
                    </div>
            ...
            <div class="row">
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="Login">
                     <form role="form" class="form-horizontal" action="<?php echo base_url();?>Trader/sendmail_property/<?php echo $query[0]->productID;?>" method="post">
                        </br> 
                        <div class="form-group">
