                            ...
                            <div class="row">
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="call_for_price" id="chkbox_callpr1"  class="form-control reginputs"><span id="call_for_price2" >Call for Price</span>
                                ...
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                       <label for="price" class="addpost_lbl">Add Price</label>
                                        <input type="text" name="txtprice"  id="txt_bprice" class="form-control reginputs" >
                                          <label id="err_txtbprice" class="txt_errors">Enter Price</label>
     ...
     function readaudioURL(input) {
            ...
            $(document).ready(function(){
                $('#chkbox_callpr1').click(function(){
                    ...
                    {
                        $('#txt_bprice').attr("disabled","disabled");
                        
                    }
                    else
                    {
                        $('#txt_bprice').removeAttr("disabled");
                ...
                $('#btnbikeadpost').click(function () {
                   
            var res = $('#chkbox_callpr1').is(':checked');
            var txtprice = $('#txt_bprice').val();
            ...
            if ((txtcat == '') || (txtbrand == '') || (txtmodel == '') || (txtyear == '') || (txtdetails == '') || (txtaudio == ''))
            {
                ...
                if ($('#chkbox_callpr1').is(':checked'))
                {
                    ...
                    $('#err_txtbprice').css('display', 'none');

                } else
                {
                    if (txtprice == '')
                    {
                        $('#err_txtbprice').css('display', 'block');
                    }
