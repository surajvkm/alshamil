                                ...
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                       <label for="price" class="addpost_lbl">Price</label>
                                        <input type="checkbox" name="price" id="chkbox_callpr1" class="form-control reginputs"><span id="call_for_price4" >Call for Price</span>
<!--                                          <label id="err_txtprice" class="txt_errors">Enter Price</label>-->
                            ...
                            <div class="row">
                                <div class="col-sm-12" >
                                    ...
                                    <img src="<?php echo base_url();?>img/no_preview.png" class="editfiveimgs" id="five_post_imgs1">
                                    <img src="<?php echo base_url();?>img/no_preview.png" class="editfiveimgs" id="five_post_imgs2">
                                    <img src="<?php echo base_url();?>img/no_preview.png" class="editfiveimgs" id="five_post_imgs3">
                                    <img src="<?php echo base_url();?>img/no_preview.png" class="editfiveimgs" id="five_post_imgs4"> 
                                     <img src="<?php echo base_url();?>img/no_preview.png" class="editfiveimgs" id="five_post_imgs5"> 
