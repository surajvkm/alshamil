                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div id="category_title_div">
                                         ...
                                         <h5 id="category_title">NUMBER PLATE</h5><!--hr id="category_hr"--><b><span id="category_cnt">(<b><?php echo $count?></b> Product Listed)</span></b>
                            ...
                            <div class="col-sm-3 catpostimgs">
                                <img src="<?php echo $r->productImage?>" class="post_imgs" onclick="show_details('<?php echo $r->productID?>','<?php echo $r->productCategoryID;?>')"> 
                                    <div class="tradet_details">
                                       <span class="wlprdpr">Product</span>&nbsp;&nbsp;<b><span class="prdt_price_details"><?php echo $r->productCategoryName?></span></b><br>
                                       <?php $currency = "AED";?>
                                       <span class="wlprdpr">Price</span>&nbsp;&nbsp;<b><span class="price_span"><?php echo $currency." ".$r->productNPPrice?></span></b>
                                        <hr class="cat_hr">
                                        <?php
                                    if($r->traderImage != '')
                                    {
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next"><i class="glyphicon glyphicon-chevron-right" id="most_right_caro"></i></a>
        ...
        <script>
            function show_details(product_id,cat_id)
            {
                ...
                //location.href='<?php echo base_url()?>Trader/show_noplate_details/'+product_id+'/'+hidcnt;
                location.href='<?php echo base_url()?>Trader/show_noplate_details/'+product_id+'/'+cat_id;
