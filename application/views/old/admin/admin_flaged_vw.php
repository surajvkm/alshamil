                                                                    ...
                                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="row mt-2">
                                                                            ...
                                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-7 pl-0">
                                                                                <p class="mb-0 text-s13 text-semibold textresize" style="color: #262626;"><?= $r['product']; ?></p>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-7 pl-0 pr-sm-3 pr-md-3 pr-0">
                                                                                <p class="mb-0 text-s13 text-semibold textresize" style="color: #262626;"><?php echo ($r['callPrice']==1)? 'Call for price':'AED '.$r['Price']; ?></p>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="col-6">
                                                            ...
                                                            <div class="col-12 px-md-3 px-sm-3 px-2">
                                                                <div class="row mb-2 mt-1">
                                                                    ...
                                                                    <div class="col-10 pr-lg-1 pl-lg-3">
                                                                        <p class="flaggedDate"><?= $r['falgedDate']?></p>
                                                                        <p class="mb-0 text-s12 textresize text-orange text-semibold"><?= $r['flagUserName']?></p>
                                                        ...
                                                        <div class="row mt-4">
                                                            <div class="col-6 pl-0 pr-md-2 pr-sm-2 pr-0">
                                                                <button onclick="discard(<?= $r['flagID']?>)" class="btn btn-orange w-100 pt-1 pb-1 text-s14 br-4">
                                                                    Discard
                                                                </button>
                                                            </div>
...
?>
            ...
            <script>
                ...
                function discard(flagId){
                    ...
                    if (r == true) {
                         location.href='<?php echo base_url()?>admin/Dashboard/discardFlagged/'+flagId;
                    } 
