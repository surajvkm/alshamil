                                ...
                                <div class="col-lg-10 col-12 mx-lg-auto">
                                    <div class="row">
                                       <?php 
                                        ...
                                        <a href='<?php echo ($r->planStatus==1)? base_url('admin/Dashboard/plan_profile/').$r->traderID:base_url('admin/Dashboard/new_registers/'); ?>'>
                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 col-md-4 col-3 pr-0">
                                                                 ...
                                                                 if($r->traderImage != '')
                                                                    {
                                                                        ?>
                                                                        <img class="userImageT" src="<?php echo $r->traderImage?>" alt="image not found">
                                                                    <?php
                                                                    }
                                                                    else
                                                                    {
                                                                ...
                                                                <div class="col-lg-9 col-md-8 col-9 pt-2 pr-0 ">
                                                                    <p class="mb-0 text-s14 text-orange text-semibold text-resize"><?php echo $r->traderFullName?></p>
                                                                    <p class="mb-0 text-s14 text-black text-semibold text-resize"><?php echo $r->traderLocation?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
