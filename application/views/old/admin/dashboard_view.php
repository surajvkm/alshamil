                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6 col-6 pl-0 pt-lg-3 pt-2 text-right pr-md-3 pr-sm-2 pr-1">
                                                                        <a class="text-s16 text-orange text-semibold text-resize text-trader" href="<?php echo base_url('admin/Dashboard/view_all_traders')?>" >View all</a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    ?>
                                                                        <div class="col-lg-12 mt-3 scaleDiv">
                                                                                <a href="<?php echo base_url()?>admin/Dashboard/plan_profile/<?php echo $result->traderID.'/'.$result->planID;?>">
                                                                                    <div class="row">
                                                                                            ...
                                                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-2 pl-lg-2 pl-0 pr-md-3 pr-sm-3 pr-0">
                                                                                                    ...
                                                                                                    ?>
                                                                                                        ...
                                                                                                        <img class="userImageD" src="<?= $result->traderImage;?>" alt="">
                                                                                            ...
                                                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-10 pl-lg-3 pl-md-2 user-padding">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-lg-8 col-8 pr-0 pl-1 pt-lg-2 pt-md-0 pt-sm-0 pt-2">
                                                                                                        <p class="mb-0 text-s13 textresize text-adjust text-semibold pl-sm-2 pl-md-3 pl-lg-0 pl-1" style="color: #535353;"><?php echo $result->traderFullName;?></p>
                                                                                                        <p class="mb-0 text-s12 textresize text-adjust text-semibold pl-sm-2 pl-md-3 pl-lg-0 pl-1" style="color: #535353;"><?php echo $result->traderLocation;?></p>
                                                                                                    </div>

                                                                                                    <!-- Post Number -->
                                                                                                    <div class="col-lg-4 col-4 pt-lg-2 pl-lg-3 pl-2 postnumber-padding">
                                                                                                        <p class="mb-0 text-s13 textresize text-adjust text-semibold pl-md-0 pl-sm-0 pl-4" style="color: #535353;"><?php echo $result->traderPostCount;?></p>
