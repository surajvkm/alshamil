                                        ...
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="row">
                                                <div class="card card-product">
                                                    <a href="<?php echo base_url().'admin/Dashboard/watchlist_detail/'.$row->traderID."/".$row->postID;  ?>">
                                                        <div class="col-12">
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        ...
                                                                        <div class="col-8 pl-0 pr-0">
                                                                            <p class="mb-0 text-s13 text-semibold" style="color: #262626;"><?php echo $row->productName?></p>
                                                                        </div>
                                                                    </div>
